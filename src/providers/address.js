...
var provider = {
	...
	secondary_address_formants: ['Apt. ###', 'Suite ###'],
	...
	zip: function() {
		return this.numerify(this.random_element(this.postcode_formats));
	},
	...
	address: function() {
		return this.join(this.address1, this.address2);
	},

	address1: function() {
		return this.join(this.building_number, this.street);
	},

	address2: function() {
		return this.numerify(this.random_element(this.secondary_address_formants));
	},
